...
<header> 
    ...
    <div id="container">
            <h2 id="subtitle1">Resgates</h2>
            <p>Confira a galeria de animais resgatados</p>
            <img class="img-resgates" src="../imagens/resgate1.jpg" alt="coletivomato" title="Resgates">
            <img class="img-resgates" src="../imagens/resgate2.jpg" alt="coletivomato" title="Resgates">
            <img class="img-resgates" src="../imagens/resgate3.jpg" alt="coletivomato" title="Resgates">
            <img class="img-resgates" src="../imagens/resgate4.jpg" alt="coletivomato" title="Resgates">
            <img class="img-resgates" src="../imagens/resgate5.jpg" alt="coletivomato" title="Resgates">
            <img class="img-resgates" src="../imagens/resgate6.jpg" alt="coletivomato" title="Resgates">
            <img class="img-resgates" src="../imagens/resgate7.jpg" alt="coletivomato" title="Resgates">
            <img class="img-resgates" src="../imagens/resgate8.jpg" alt="coletivomato" title="Resgates">
