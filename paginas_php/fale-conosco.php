...
<body >
    ...
    <div id="formulario">
        <form action="../index.php" method="host"><!--ENVIAR PARA O ARQUIVO dados.php method="post"-->
            ...
            <label>(DDD): 
                <input type="text" name="ddd" placeholder="DDD" maxlength="3" minlength="3" required>
            </label>
            <label>Telefone: 
                <input type="text" name="telefone" placeholder="Telefone" maxlength="9" minlength="9" required>
            </label><br>
            <label>Assunto: 
